...
handlers.set(key('GET', '/accounts/6/positions'), () => [
  { product: 'SPOT', ticker: 'BTC', quantity: 0.01204, principal: null, interest: null, currentPriceEur: 92100, currentValueEur: 1108.88 },
  { product: 'SPOT', ticker: 'ETH', quantity: 0.031906, principal: null, interest: null, currentPriceEur: 4116, currentValueEur: 131.32 },
  { product: 'STAKING', ticker: 'ATOM', quantity: 33.154, principal: 19.73, interest: 13.424, currentPriceEur: 5.65, currentValueEur: 187.32 },
  { product: 'LENDING', ticker: 'USDT', quantity: 75.01, principal: 75, interest: 0.01, currentPriceEur: 0.92, currentValueEur: 69.01 },
])
...
handlers.set(key('POST', '/crypto/exchange'), (config) => {
  ...
  return {
    id: Date.now(), name: provider, type: 'CRYPTO' as const, provider, currency: 'EUR', currentBalance: 0, currentBalanceEur: 0, lastSyncedAt: null, isManual: false, color: '#f59e0b', ticker: null, createdAt: new Date().toISOString()
  }
})
