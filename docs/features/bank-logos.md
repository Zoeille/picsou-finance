...
- `backend/src/test/java/com/picsou/service/AccountServiceTest.java` — `update()` stores the key the picker sent, and keeps the stored one when the request omits it.
